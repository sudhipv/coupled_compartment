...
# MLE estimates
# [ 1.48024018e-01 -1.06192624e-01  5.96551784e-02 -6.09307671e-02
#   2.01019087e-02  8.61353607e-02 -4.69533788e-02 -5.14049636e-03
#   4.30000013e+02  4.30000004e+02]

bval = 0.2


x_MLE_low = [0,                    0,                1.48024018e-01  - bval, -1.06192624e-01 - bval,  5.96551784e-02  - bval, -6.09307671e-02 - bval, 2.01019087e-02  - bval,  8.61353607e-02 - bval, -4.69533788e-02 - bval,  -5.14049636e-03-bval]

x_MLE_up = [ 0.001 * 2794356.0, 0.001 * 2794356.0,  0.15052827 + bval, -1.06192624e-01 + bval,  5.96551784e-02  + bval, -6.09307671e-02 + bval, 2.01019087e-02 + bval,  8.61353607e-02 + bval, -4.69533788e-02 + bval, -5.14049636e-03+bval ]
...
if __name__ == '__main__': #the main part of the program.
    ...
    Xsmp,Chain,_,comm = run_tmcmc(Nsmp,all_params,logposterior,parallel_processing,f'{datapath}/stat-file-tmcmc_toronto_real.txt')
...
##### IF YOU WANT TO LOAD PREVIOUSLY GENERATED SAMPLES 
    ...
    Xsmp = Xsmp.T
    np.savetxt(f'{datapath}/muVec_toronto_real.dat',Xsmp)
    np.savetxt(f'{datapath}/muVec_long_toronto_real.dat',Chain)
